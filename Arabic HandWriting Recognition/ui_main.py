...
################################################################################
## Form generated from reading UI file 'mainmgRjDQ.ui'
##
...
"")
        ...
        self.toggleButton.setStyleSheet(u"background-image: url(:/icons/resources_images/icons/icon_menu.png);")
        ...
        self.btn_home.setStyleSheet(u"background-image: url(:/icons/resources_images/icons/cil-home.png);")
        ...
        self.btn_preprocessing.setStyleSheet(u"background-image: url(:/icons/resources_images/icons/cil-pencil.png);\n"
"")
        ...
        self.btn_segmentation.setStyleSheet(u"background-image: url(:/icons/resources_images/icons/cil-cut.png);")
        ...
        icon = QIcon()
        icon.addFile(u":/icons/resources_images/icons/cil-minus.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon1 = QIcon()
        icon1.addFile(u":/icons/resources_images/icons/icon_maximize.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon2 = QIcon()
        icon2.addFile(u":/icons/resources_images/icons/icon_close.png", QSize(), QIcon.Normal, QIcon.Off)
...
"")
        ...
        self.horizontalLayout_8.addWidget(self.btn_applyRotation)
        ...
        self.horizontalLayout_8.addWidget(self.btn_revertRotaion)
        ...
        self.blur_value = QLabel(self.frame_3)
        self.blur_value.setObjectName(u"blur_value")

        self.verticalLayout_10.addWidget(self.blur_value)
        ...
        self.thresh_value = QLabel(self.frame_2)
        self.thresh_value.setObjectName(u"thresh_value")

        self.verticalLayout_7.addWidget(self.thresh_value)
        ...
        self.dot_value = QLabel(self.frame_4)
        self.dot_value.setObjectName(u"dot_value")

        self.verticalLayout_12.addWidget(self.dot_value)
...
"")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.blur_value.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p align=\"right\"><br/></p></body></html>", None))
        ...
        self.thresh_value.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p align=\"right\"><br/></p></body></html>", None))
        ...
        self.dot_value.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p align=\"right\"><br/></p></body></html>", None))
