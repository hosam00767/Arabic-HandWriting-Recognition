...
################################################################################
## Form generated from reading UI file 'mainkuwmfB.ui'
##
...
"")
        ...
        sizePolicy.setHeightForWidth(self.btn_segmentaion.sizePolicy().hasHeightForWidth())
        self.btn_segmentaion.setSizePolicy(sizePolicy)
        self.btn_segmentaion.setMinimumSize(QSize(0, 45))
        self.btn_segmentaion.setFont(font)
        self.btn_segmentaion.setCursor(QCursor(Qt.PointingHandCursor))
        self.btn_segmentaion.setLayoutDirection(Qt.LeftToRight)
        self.btn_segmentaion.setStyleSheet(u"background-image: url(:/icons/images/icons/cil-gamepad.png);")
        icon = QIcon()
        icon.addFile(u":/icons/images/icons/cil-pencil.png", QSize(), QIcon.Normal, QIcon.Off)
        self.btn_segmentaion.setIcon(icon)
        ...
        self.pagesContainer.setMinimumSize(QSize(1198, 0))
...
"background-repeat: no-repeat;")
        ...
        self.threshHoldSlider = QSlider(self.widgets)
        ...
        self.verticalLayout.addWidget(self.threshHoldSlider)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btn_segmentaion.setText(QCoreApplication.translate("MainWindow", u"Widgets", None))
        ...
        self.label.setText(QCoreApplication.translate("MainWindow", u"image2", None))
